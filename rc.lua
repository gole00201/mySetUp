...
screenshot = "~/Pictures/$(date +%F_%T).png"
...
function scrot_selection()
    scrot("scrot -s " .. screenshot .. " -e 'xclip -selection clipboard -t image/png -i $f'", scrot_callback, "Take a screenshot of selection")
end
...
local editor       = os.getenv("code") or "code"
